...
ok(html.includes('v3.5.1_43'),'user-visible version label updated to v3.5.1_43');
...
console.log(`RESULT - ${pass}/${pass+fail} v3.5.1.43 market-health/Overview regression checks PASS`);
