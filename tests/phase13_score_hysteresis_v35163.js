...
const base=fs.readFileSync(path.join(root,'app_v35162_baseline.js'),'utf8');
...
console.log(`RESULT - ${p}/${p+f} Phase 13 score hysteresis checks ${f?'FAIL':'PASS'}`); if(f)process.exit(1);
