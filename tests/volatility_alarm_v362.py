...
ck('version 3.6.2 / code 112', "EXPORT_V47_VERSION='3.6.2',EXPORT_V47_CODE=112" in app)
ck('gradle version', 'versionCode 112' in (root/'app/build.gradle').read_text() and "versionName '3.6.2'" in (root/'app/build.gradle').read_text())
ck('visible header v3.6.2', 'v3.6.2</div>' in idx and 'v3.5.1_75</div>' not in idx)
