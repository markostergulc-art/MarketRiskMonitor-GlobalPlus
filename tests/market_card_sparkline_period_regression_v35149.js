...
ok(/versionCode\s+82/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3.5.1.49'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.49 / versionCode 82 metadata');
ok(html.includes('v3.5.1_49'),'visible UI version is v3.5.1_49');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.49 Markets-card sparkline-period regression checks PASS`);if(f)process.exit(1);
