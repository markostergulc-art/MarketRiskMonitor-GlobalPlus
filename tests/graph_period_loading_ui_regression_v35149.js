...
const base=fs.readFileSync('app_v35148_baseline.js','utf8');
...
ok(/versionCode\s+82/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3.5.1.49'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.49 / versionCode 82 source metadata');
ok(html.includes('v3.5.1_49'),'visible version label is v3.5.1_49');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.49 graph/loading UI regression checks PASS`);if(f)process.exit(1);
