...
ok(html.includes('v3.5.1_47'),'user-visible version label updated to v3.5.1_47');
...
console.log(`RESULT - ${pass}/${pass+fail} v3.5.1.47 market-health/Overview regression checks PASS`);
