...
ok(/versionCode\s+78/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3\.5\.1\.45'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.45 / versionCode 78 source metadata');
ok(html.includes('v3.5.1_45'),'visible version label is v3.5.1_45');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.45 graph/loading UI checks PASS`);if(f)process.exit(1);
