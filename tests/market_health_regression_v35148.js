...
ok(html.includes('v3.5.1_48'),'user-visible version label updated to v3.5.1_48');
...
console.log(`RESULT - ${pass}/${pass+fail} v3.5.1.48 market-health/Overview regression checks PASS`);
