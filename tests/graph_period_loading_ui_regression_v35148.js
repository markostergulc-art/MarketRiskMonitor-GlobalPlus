...
ok(/versionCode\s+81/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3\.5\.1\.48'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.48 / versionCode 81 source metadata');
ok(html.includes('v3.5.1_48'),'visible version label is v3.5.1_48');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.48 graph/loading UI regression checks PASS`);if(f)process.exit(1);
