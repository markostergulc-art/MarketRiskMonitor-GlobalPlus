...
ck('version 3.6.1 / code 111', "EXPORT_V47_VERSION='3.6.1',EXPORT_V47_CODE=111" in app)
ck('gradle version', 'versionCode 111' in (root/'app/build.gradle').read_text() and "versionName '3.6.1'" in (root/'app/build.gradle').read_text())
ck('visible header v3.6.1', 'v3.6.1</div>' in idx and 'v3.5.1_75</div>' not in idx)
