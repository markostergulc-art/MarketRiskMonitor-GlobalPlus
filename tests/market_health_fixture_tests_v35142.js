...
ok(html.includes('v3.5.1_42'),'user-visible version label updated to v3.5.1_42');
...
console.log(`RESULT - ${pass}/${pass+fail} v3.5.1.42 market-health/Overview checks PASS`);
