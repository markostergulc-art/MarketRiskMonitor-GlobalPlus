...
ok(/versionCode\s+92\b/.test(gradle),'versionCode 92');
ok(/versionName\s+['"]3\.5\.1\.59['"]/.test(gradle),'versionName 3.5.1.59');
ok(html.includes('v3.5.1_59'),'visible header v3.5.1_59');
ok(/VERSION_NAME="3\.5\.1\.59"/.test(release)&&/VERSION_CODE="92"/.test(release),'release metadata v3.5.1.59 / 92');
ok(java.includes('MarketRiskMonitor/3.5.1.59'),'native user-agent version 3.5.1.59');
ok(src.includes("const EXPORT_V47_VERSION='3.5.1.59',EXPORT_V47_CODE=92"),'export metadata v3.5.1.59 / 92');
