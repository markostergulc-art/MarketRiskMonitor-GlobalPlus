...
ok(/versionCode\s+95\b/.test(gradle),'versionCode 95');
ok(/versionName\s+['"]3\.5\.1\.62['"]/.test(gradle),'versionName 3.5.1.62');
ok(html.includes('v3.5.1_62'),'visible header v3.5.1_62');
ok(/VERSION_NAME="3\.5\.1\.62"/.test(release)&&/VERSION_CODE="95"/.test(release),'release metadata v3.5.1.62 / 95');
ok(java.includes('MarketRiskMonitor/3.5.1.62'),'native user-agent version 3.5.1.62');
ok(src.includes("const EXPORT_V47_VERSION='3.5.1.62',EXPORT_V47_CODE=95"),'export metadata v3.5.1.62 / 95');
