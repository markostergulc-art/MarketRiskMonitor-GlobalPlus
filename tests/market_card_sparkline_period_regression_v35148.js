...
ok(/versionCode\s+81/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3\.5\.1\.48'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.48 / versionCode 81 metadata');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.48 Markets-card sparkline-period regression checks PASS`);if(f)process.exit(1);
