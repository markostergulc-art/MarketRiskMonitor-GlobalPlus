...
ok(/versionCode\s+91\b/.test(gradle),'versionCode 91');
ok(/versionName\s+['"]3\.5\.1\.58['"]/.test(gradle),'versionName 3.5.1.58');
ok(html.includes('v3.5.1_58'),'visible header v3.5.1_58');
ok(/VERSION_NAME="3\.5\.1\.58"/.test(release)&&/VERSION_CODE="91"/.test(release),'release metadata v3.5.1.58 / 91');
ok(java.includes('MarketRiskMonitor/3.5.1.58'),'native user-agent version 3.5.1.58');
ok(src.includes("const EXPORT_V47_VERSION='3.5.1.58',EXPORT_V47_CODE=91"),'export metadata v3.5.1.58 / 91');
