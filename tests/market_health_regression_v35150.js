...
ok(html.includes('v3.5.1_50'),'user-visible version label updated to v3.5.1_50');
...
console.log(`RESULT - ${pass}/${pass+fail} v3.5.1.50 market-health/Overview regression checks PASS`);
