...
ok(/versionCode\s+80/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3\.5\.1\.47'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.47 / versionCode 80 metadata');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.47 Markets-card sparkline-period regression checks PASS`);if(f)process.exit(1);
