...
ok(src.includes('if(trading212ConfiguredV74())ensureTrading212AvailabilityV74(false)'), 'global startup loads availability catalog');
ok(src.includes("EXPORT_V47_VERSION='3.5.1.74',EXPORT_V47_CODE=107"),'release export identity updated');
