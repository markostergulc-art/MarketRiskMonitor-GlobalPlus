...
ok(java.includes('MarketRiskMonitor/3.5.1.66'),'native user-agent version 3.5.1.66');
...
ok(src.includes('safeGlobalRiskModelV65(countries,combinedEarly,crossAsset,corrSystemic,globalMacroCycleV59,fiscalRowsV65)'),'GLOBAL contagion amplifier receives lag-aware matrix');
