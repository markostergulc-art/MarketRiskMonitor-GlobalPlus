...
ok(html.includes('id="loadPriorityStatus"')&&html.includes('v3.5.1_57'),'loading-priority status UI and v44 visible version present');
console.log(`RESULT - ${p}/${p+f} v3.5.1.57 Phase 7 compatibility freshness/loading checks PASS`);if(f)process.exit(1);
