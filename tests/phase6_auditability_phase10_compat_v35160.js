...
ok(/versionCode\s+93\b/.test(gradle),'versionCode 93');
ok(/versionName\s+['"]3\.5\.1\.60['"]/.test(gradle),'versionName 3.5.1.60');
ok(html.includes('v3.5.1_60'),'visible header v3.5.1_60');
ok(/VERSION_NAME="3\.5\.1\.60"/.test(release)&&/VERSION_CODE="93"/.test(release),'release metadata v3.5.1.60 / 93');
ok(java.includes('MarketRiskMonitor/3.5.1.60'),'native user-agent version 3.5.1.60');
ok(src.includes("const EXPORT_V47_VERSION='3.5.1.60',EXPORT_V47_CODE=93"),'export metadata v3.5.1.60 / 93');
