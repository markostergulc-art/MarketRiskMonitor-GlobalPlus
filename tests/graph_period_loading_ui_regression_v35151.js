...
ok(/versionCode\s+84/.test(fs.readFileSync('app/build.gradle','utf8'))&&/versionName\s+'3.5.1.51'/.test(fs.readFileSync('app/build.gradle','utf8')),'v3.5.1.51 / versionCode 84 source metadata');
ok(html.includes('v3.5.1_51'),'visible version label is v3.5.1_51');
...
console.log(`RESULT - ${p}/${p+f} v3.5.1.51 graph/loading UI regression checks PASS`);if(f)process.exit(1);
