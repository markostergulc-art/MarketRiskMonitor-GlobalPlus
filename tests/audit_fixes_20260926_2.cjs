...
(async()=>{
  ...
  let gradle=fs.readFileSync('app/build.gradle','utf8');ok('F13 release identity is 2026.09.26.2 / 125',/versionCode\s+125/.test(gradle)&&/versionName\s+'2026.09.26.2'/.test(gradle));
