...
(async()=>{
  ...
  let gradle=fs.readFileSync('app/build.gradle','utf8');ok('F13 release identity is 2026.09.26.1 / 124',/versionCode\s+124/.test(gradle)&&/versionName\s+'2026\.09\.26\.1'/.test(gradle));
