...
ok(html.includes('v3.5.1_49'),'user-visible version label updated to v3.5.1_49');
...
console.log(`RESULT - ${pass}/${pass+fail} v3.5.1.49 market-health/Overview regression checks PASS`);
