...
apk=Path(sys.argv[1] if len(sys.argv)>1 else '/mnt/data/MarketRiskMonitor_GlobalPlus_v3.5.1.45.apk')
...
assert man['versionCode'][2]==78
assert man['versionName'][0]=='3.5.1.45'
...
print('PASS - versionName 3.5.1.45 / versionCode 78')
