...
OUT=ROOT/'manual_apk_build_v35152'
...
xml+=sel('manifest',[attr(None,'package','com.marko.marketrisk.globalplus'),attr(AURI,'versionCode',dtype=TYPE_INT_DEC,data_val=85),attr(AURI,'versionName','3.5.1.52')])
...
unsigned=OUT/'MarketRiskMonitor_GlobalPlus_v3.5.1.52_unsigned.apk'
