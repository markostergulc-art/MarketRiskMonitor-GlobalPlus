...
ROOT=Path('/mnt/data/MarketRiskMonitor_Android_v3_2')
OUT=Path('/mnt/data/manual_apk_build_v32')
...
P_VIEW_INT=(VIEW,(INT,)); P_BOOL0=(BOOL,())
methods=[
 (ACT,'<init>',P_VOID0),(ACT,'onCreate',P_VOID_BUNDLE),(ACT,'onBackPressed',P_VOID0),(ACT,'setContentView',P_VOID_VIEW),(ACT,'findViewById',P_VIEW_INT),
...
sp=list(attr_ids)+['android','http://schemas.android.com/apk/res/android','manifest','uses-sdk','uses-permission','application','activity','intent-filter','action','category','package','com.marko.marketrisk.globalplus','3.2.0','Market Risk Monitor Global+','android.permission.INTERNET','com.marko.marketrisk.globalplus.MainActivity','android.intent.action.MAIN','android.intent.category.LAUNCHER']
...
xml+=sel('manifest',[attr(None,'package','com.marko.marketrisk.globalplus'),attr(AURI,'versionCode',dtype=TYPE_INT_DEC,data_val=32),attr(AURI,'versionName','3.2.0')])
xml+=sel('uses-sdk',[attr(AURI,'minSdkVersion',dtype=TYPE_INT_DEC,data_val=26),attr(AURI,'targetSdkVersion',dtype=TYPE_INT_DEC,data_val=29)]);xml+=eel('uses-sdk')
...
unsigned=OUT/'MarketRiskMonitor_GlobalPlus_v3.2.0_unsigned.apk'
