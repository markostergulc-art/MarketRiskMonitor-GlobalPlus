...
apk=Path(sys.argv[1] if len(sys.argv)>1 else '/mnt/data/MarketRiskMonitor_GlobalPlus_v3.10_BUILD123_signed.apk')
...
assert man['package'][0]=='com.marko.marketrisk.globalplus'; assert man['versionCode'][2]==123; assert man['versionName'][0]=='3.10'
