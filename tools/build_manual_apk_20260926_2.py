...
OUT=ROOT/'manual_apk_build_20260926_2'
...
sp=list(attr_ids)+['android','http://schemas.android.com/apk/res/android','manifest','uses-sdk','uses-permission','application','activity','intent-filter','action','category','package','com.marko.marketrisk.globalplus','2026.09.26.2','Market Risk Monitor Global+','android.permission.INTERNET','com.marko.marketrisk.globalplus.MainActivity','android.intent.action.MAIN','android.intent.category.LAUNCHER']
...
xml+=sel('manifest',[attr(None,'package','com.marko.marketrisk.globalplus'),attr(AURI,'versionCode',dtype=TYPE_INT_DEC,data_val=125),attr(AURI,'versionName','2026.09.26.2')])
...
with zipfile.ZipFile(unsigned,'w',compression=zipfile.ZIP_DEFLATED) as z:
    ...
    z.write(OUT/'economic_structure_v125.js','assets/economic_structure_v125.js',compress_type=zipfile.ZIP_DEFLATED)
...
aligned=OUT/'MarketRiskMonitor_GlobalPlus_2026.09.26.2_unsigned_aligned.apk'
