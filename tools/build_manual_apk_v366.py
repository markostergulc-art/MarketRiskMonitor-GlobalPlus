...
OUT=ROOT/'manual_apk_build_v366'
...
sp=list(attr_ids)+['android','http://schemas.android.com/apk/res/android','manifest','uses-sdk','uses-permission','application','activity','intent-filter','action','category','package','com.marko.marketrisk.globalplus','3.6.6','Market Risk Monitor Global+','android.permission.INTERNET','com.marko.marketrisk.globalplus.MainActivity','android.intent.action.MAIN','android.intent.category.LAUNCHER']
...
xml+=sel('manifest',[attr(None,'package','com.marko.marketrisk.globalplus'),attr(AURI,'versionCode',dtype=TYPE_INT_DEC,data_val=116),attr(AURI,'versionName','3.6.6')])
...
# ---------------- assets + APK ----------------
html=(ROOT/'app/src/main/assets/index.html').read_bytes();excel_js=(ROOT/'app/src/main/assets/excel_export_v362.js').read_bytes();t212_js=(ROOT/'app/src/main/assets/t212_portfolio_v363.js').read_bytes();cr116_js=(ROOT/'app/src/main/assets/capital_rotation_contributors_v366.js').read_bytes();icon=(ROOT/'app/src/main/assets/app_icon.png').read_bytes();(OUT/'index.html').write_bytes(html);(OUT/'excel_export_v362.js').write_bytes(excel_js);(OUT/'t212_portfolio_v363.js').write_bytes(t212_js);(OUT/'capital_rotation_contributors_v366.js').write_bytes(cr116_js);(OUT/'app_icon.png').write_bytes(icon)
unsigned=OUT/'MarketRiskMonitor_GlobalPlus_v3.6.6_unsigned.apk'
...
aligned=OUT/'MarketRiskMonitor_GlobalPlus_v3.6.6_unsigned_aligned.apk'
