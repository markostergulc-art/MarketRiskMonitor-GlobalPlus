...
apk=Path(sys.argv[1] if len(sys.argv)>1 else '/mnt/data/MarketRiskMonitor_GlobalPlus_v3.5.1.43.apk')
...
assert man['versionCode'][2]==76
assert man['versionName'][0]=='3.5.1.43'
...
print('PASS - versionName 3.5.1.43 / versionCode 76')
