...
OUT=ROOT/'manual_apk_build_v35129'
...
sp=list(attr_ids)+['android','http://schemas.android.com/apk/res/android','manifest','uses-sdk','uses-permission','application','activity','intent-filter','action','category','package','com.marko.marketrisk.globalplus','3.5.1.29','Market Risk Monitor Global+','android.permission.INTERNET','com.marko.marketrisk.globalplus.MainActivity','android.intent.action.MAIN','android.intent.category.LAUNCHER']
...
xml+=sel('manifest',[attr(None,'package','com.marko.marketrisk.globalplus'),attr(AURI,'versionCode',dtype=TYPE_INT_DEC,data_val=61),attr(AURI,'versionName','3.5.1.29')])
...
unsigned=OUT/'MarketRiskMonitor_GlobalPlus_v3.5.1_29_unsigned.apk'
